...
const IntroPost = ({ postId }) => {
  ...
  const list = lists.find((each) => each.id === parseInt(postId));
//   console.log(list);
  return (
    <div>
      <div
        className="grid grid-cols-1 md:grid-cols-2 mt-10 px-10 md:px-15
      ...
      >
        ...
        <div>
          ...
          <h4 className="line-clamp-8 text-gray-400 mt-5">
            {list.description}
          </h4>
